...
import { removeFromBasket, selectBasketTotal, selectTheBasketItems } from '../features/basketSlice';
...
const BasketScreen = () => {
    ...
    const items = useSelector(selectTheBasketItems);
    ...
    <SafeAreaView className='flex-1 bg-white'>
        <View className='flex-1 bg-gray-100'>
            ...
            <View className='flex-row items-center space-x-4 px-4 py-3 bg-white my-5'>
                <Image source={{ uri: "https://links.papareact.com/wru"}} className='h-7 w-9 bg-gray-300 p-4 rounded-full'/>
                <Text className='flex-1'>Delivery in 35-55 min</Text>
                <TouchableOpacity>
            ...
            <View className='p-5 bg-white mt-5 space-y-4' >
                ...
                <View className='flex-row justify-between'>
                    ...
                    <Text className='text-gray-500' >
                        <Currency quantity={14.78} currency='ZAR'/>
                    </Text>
                </View>
                <View className='flex-row justify-between'>
                    <Text  >Order Total</Text>
                    <Text className='font-extrabold' >
                        <Currency quantity={basketTotal + 14.78} currency='ZAR'/>
                    </Text>
                </View>
